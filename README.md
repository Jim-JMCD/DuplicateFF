...
This repository only contains X86-64 excutable.  For the ARM verion go to [DuplicateFF_for_ARM_aarch64](https://github.com/Jim-JMCD/DuplicateFF_for_ARM_aarch64)
